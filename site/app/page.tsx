  ...
  return (
    <main>
      <nav className="nav shell">
        ...
        <a className="button small" href="/assessments#contact">Request an assessment <span>↗</span></a>
      </nav>
      ...
      <section className="hero shell">
        ...
        <div className="hero-actions">
          <a className="button" href="/assessments">Assess your MCPs <span>→</span></a>
          <a className="button ghost" href="/enterprise">Enterprise monitoring</a>
        </div>
      ...
      <section className="cta shell"><div className="eyebrow">THE MCP SECURITY RECORD</div><h2>Trust your agents.<br/><span>Know their tools.</span></h2><p>Explore independently verified intelligence or scan the MCP servers already in your stack.</p><div className="hero-actions"><a className="button" href="/catalog">Explore the catalog →</a><a className="button ghost" href="/scanner">Scan your MCPs</a></div></section>
